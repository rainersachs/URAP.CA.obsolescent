...
```{r}
v1 <- data.frame(lower = vector(length = length(d1) ),upper = vector(length = length(d1) ))
...
for (i in 1:length(d1)) {
  a = CI_function_MIXDER_MC_2(d = c(0, two_ion_MIXDER1$d[i]), d_interested = two_ion_MIXDER1$d[i], r = rep(1/2, times = 2),  L = c(100, 175), Z.b = c(690, 1075))
  v1$lower[i] = a[1]
  v1$upper[i] = a[2]
  print(a)
...
two_ion_MIXDER1$CI_lower = ninty_five_CI_lower + 0.00071
two_ion_MIXDER1$CI_upper = ninty_five_CI_upper + 0.00071
...
for (i in 1:length(d2)) {
  a = CI_function_MIXDER_MC_2(d = c(0, two_ion_MIXDER2$d[i]), d_interested = two_ion_MIXDER2$d[i], r = rep(1/2, times = 2),  L = c(100, 175), Z.b = c(690, 1075))
  v2$lower[i] = a[1]
  v2$upper[i] = a[2]
  print(a)
  ninty_five_CI_lower = c(ninty_five_CI_lower, a[1])
...
two_ion_MIXDER2$CI_lower = ninty_five_CI_lower + 0.00071
two_ion_MIXDER2$CI_upper = ninty_five_CI_upper + 0.00071
...
```{r}
two_ion_MIXDER2$CI_lower
CA1
two_ion_MIXDER2$CI_upper
```
