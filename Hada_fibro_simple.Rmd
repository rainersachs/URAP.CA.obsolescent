...
#param = data.frame(ion = c("O", "Si", "Ti", "Fe600", "Fe450", "Fe300"),
                  ...
                  # Z.b = c(595, 690, 770, 1075, 1245, 1585)) # Z^2/beta*^2 #595 for O is correct RKS 6/26/2018
...
#output the df
#write.csv(two_ion_MIXDER, file = "2ionMonteCarlo.csv", row.names = F)
...
#write.csv(six_ion_MIXDER, "6ionMonteCarlov.csv", row.names = F)
```
