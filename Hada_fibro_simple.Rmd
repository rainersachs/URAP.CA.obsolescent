...
NN <- 1000
eta0_MC_2 = rnorm(NN, mean = eta0_hat, sd = 4.631e-05)
eta1_MC_2 = rnorm(NN, mean = eta1_hat, sd = 1.617e-04)
sig0_MC_2 = rnorm(NN, mean = sig0_hat, sd = 1.966e+00)
kap_MC_2 = rnorm(NN, mean = kap_hat, sd = 2.628e+02)
...
sig = vcov(IDER_model)
monte_carlo_parameters = rmvnorm(n = 500, mean = c(eta0 = eta0_hat, eta1 = eta1_hat, sig0 = sig0_hat, kap = kap_hat), sigma = sig)
...
```{r}
#MIXDER of iron 2.
out = MIXDER_function(r = rep(1/2, times = 2), L = c(100, 175), Z.b = c(690, 1075), d = c(seq(0, 0.009, 0.001), seq(0.01, 0.5, by = 0.01)),eta0 = eta0_hat, eta1 = eta1_hat, sig0 = sig0_hat, kap = kap_hat)
...
for (i in 2:length(d2)) {
  a = CI_function_MIXDER_MC_2(d = c(0, two_ion_MIXDER2$d[i]), r = rep(1/2, times = 2), L=c(100, 175), Z.b = c(690, 1075))
...
six_ion_MIXDER4 = data.frame(d = out[, 1][seq(1,50, by = 5)], CA = out[, 2][seq(1,50, by = 5)] + 0.00071)
d4 = six_ion_MIXDER4$d
ninty_five_CI_lower = vector(length = 0)
ninty_five_CI_upper = vector(length = 0)
a = vector(length = 0)
for (i in 2:length(d4)) {
  a = CI_function_MIXDER_MC_2(d = c(0, six_ion_MIXDER4$d[i]), r = rep(1/6, times = 6), L = c(75, 100, 125, 175, 195, 240), Z.b = c(595, 690, 770, 1075, 1245, 1585))
  ninty_five_CI_lower = c(ninty_five_CI_lower, a[1])
  ninty_five_CI_upper = c(ninty_five_CI_upper, a[2])
}
six_ion_MIXDER4$CI_lower = c(0, ninty_five_CI_lower + 0.00071)
six_ion_MIXDER4$CI_upper = c(0, ninty_five_CI_upper + 0.00071)
