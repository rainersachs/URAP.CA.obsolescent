...
two_ion_MIXDER2 = data.frame(d = out[, 1][seq(1,61, by = 5)], CA = out[, 2][seq(1,61, by = 5)] + 0.00071)
...
```
```{r}
v1 <- data.frame(lower = vector(length = length(d1) - 1),upper = vector(length = length(d1) - 1))
...
for (i in 2:length(d1)) {
  a = CI_function_MIXDER(d = c(0, two_ion_MIXDER1$d[i]), d_interested = two_ion_MIXDER1$d[i], r = rep(1/2, times = 2),  L = c(100, 175), Z.b = c(690, 1075))
  v1$lower[i-1] = a[1]
  v1$upper[i-1] = a[2]
  print(a)
...
two_ion_MIXDER1$CI_lower = c(0, ninty_five_CI_lower + 0.00071)
two_ion_MIXDER1$CI_upper = c(0, ninty_five_CI_upper + 0.00071)
...
```
```{r}
v1$lower[seq(5,61, by = 5)] - v2$lower
v1$upper[seq(5,61,by = 5)] - v2$upper

```
```{r}
v2 <- data.frame(lower = vector(length = length(d2) - 1),upper = vector(length = length(d2) - 1))
#Then the 95% CI multivariate MC simulated ribbon
ninty_five_CI_lower = vector(length = 0)
ninty_five_CI_upper = vector(length = 0)
a = vector(length = 0)
for (i in 2:length(d2)) {
  a = CI_function_MIXDER(d = c(0, two_ion_MIXDER2$d[i]), d_interested = two_ion_MIXDER2$d[i], r = rep(1/2, times = 2),  L = c(100, 175), Z.b = c(690, 1075))
  v2$lower[i-1] = a[1]
  v2$upper[i-1] = a[2]
  print(a)
  ninty_five_CI_lower = c(ninty_five_CI_lower, a[1])
...
two_ion_MIXDER2$CI_lower = c(0, ninty_five_CI_lower + 0.00071)
two_ion_MIXDER2$CI_upper = c(0, ninty_five_CI_upper + 0.00071)
...
```{r}
#Then the 95% CI multivariate MC simulated ribbon
v3 <- data.frame(lower = vector(length = length(d3) - 1),upper = vector(length = length(d3) - 1))
ninty_five_CI_lower = vector(length = 0)
ninty_five_CI_upper = vector(length = 0)
a = vector(length = 0)
for (i in 2:length(d3)) {
  a = CI_function_MIXDER(d = c(0, six_ion_MIXDER3$d[i]), d_interested = six_ion_MIXDER3$d[i], r = rep(1/6, times = 6), L = c(75, 100, 125, 175, 195, 240), Z.b = c(595, 690, 770, 1075, 1245, 1585))
  v3$lower[i-1] = a[1]
  v3$upper[i-1] = a[2]
  print(a)
  ninty_five_CI_lower = c(ninty_five_CI_lower, a[1])
...
six_ion_MIXDER3$CI_lower = c(0, ninty_five_CI_lower + 0.00071)
six_ion_MIXDER3$CI_upper = c(0, ninty_five_CI_upper + 0.00071)
```
```{r}
v3
```
...
six_ion_MIXDER3$oxygen = IDER(d = d3, L = 75, Z.b = 595) + 0.00071
six_ion_MIXDER3$silicon = IDER(d = d3, L = 100, Z.b = 690) + 0.00071
six_ion_MIXDER3$titanium = IDER(d = d, L = 125, Z.b = 770) + 0.00071
six_ion_MIXDER3$ironsix = IDER(d = d3, L = 175, Z.b = 1075) + 0.00071
six_ion_MIXDER3$ironfour = IDER(d = d3, L = 195, Z.b = 1245) + 0.00071
six_ion_MIXDER3$ironthree = IDER(d = d3, L = 240, Z.b = 1585) + 0.00071
save(six_ion_MIXDER, file = "six_ion_95%.Rda")
