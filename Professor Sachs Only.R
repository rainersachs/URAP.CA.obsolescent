...
set.seed(11)
eta0_MC_2 = rnorm(MM, mean = 1.485e-04, sd = 2.190e-05)
eta1_MC_2 = rnorm(MM, mean = 3.514e-03, sd = 9.037e-04)
sig0_MC_2 = rnorm(MM, mean = 4.150e+00, sd = 1.366e+00)
kap_MC_2 = rnorm(MM, mean = 4.688e+02, sd = 2.469e+02)
